...
> GST & Income Tax computation assistant. Sends tax warnings and summaries to Telegram bot clients.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/taxgpt/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-taxgpt.git
cd tp-taxgpt
```
...
```bash
kubectl port-forward deployment/tp-taxgpt 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── tax_gpt.py     # Main configuration file
```
...
---
*Generated by [TaxGPT Studio](https://pradeeptalari14.github.io/portfolio/tools/taxgpt/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
